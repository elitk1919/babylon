...
export default class extends BaseSchema {
  ...
  async up() {
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'babylon_kiwix_serve'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'babylon_kolibri'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'babylon_ollama'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'babylon_flatnotes'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'babylon_cyberchef'
    `)
  }
