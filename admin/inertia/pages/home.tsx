...
const SYSTEM_ITEMS = [
  {
    ...
    target: '',
    description:
      'Not sure where to start? Use the setup wizard to quickly configure your Babylon!',
  ...
  },
  {
    ...
    to: '/docs/home',
    target: '',
    description: 'Read Babylon manuals and guides',
  ...
  },
  {
    ...
    to: '/settings/system',
    target: '',
    description: 'Configure your Babylon settings',
      ...
      <Head title="Command Center" />
      {
        updateInfo?.updateAvailable && (
          <div className='flex justify-center items-center p-4 w-full'>
            <Alert
              title="An update is available for Babylon!"
              type="info-inverted"
              variant="solid"
              className="w-full"
              buttonProps={{
