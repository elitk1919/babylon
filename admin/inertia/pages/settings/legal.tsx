...
export default function LegalPage() {
  return (
    <SettingsLayout>
      <Head title="Legal Notices | Babylon" />
        ...
        <main className="px-12 py-6 max-w-4xl">
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-4">
              Babylon integrates the following open source projects. We are grateful to
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Babylon is designed with privacy as a core principle:
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-primary">
              <li><strong>Zero Telemetry:</strong> Babylon does not collect, transmit, or store any usage data, analytics, or telemetry.</li>
              <li><strong>Local-First:</strong> All your data, downloaded content, AI conversations, and notes remain on your device.</li>
              <li><strong>No Accounts Required:</strong> Babylon operates without user accounts or authentication by default.</li>
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Babylon provides tools to download and access content from third-party sources
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Some content available through Babylon includes medical references, first aid guides,
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              All data associated with Babylon is stored locally on your device:
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-primary">
              <li><strong>Installation Directory:</strong> /opt/babylon</li>
              <li><strong>Downloaded Content:</strong> /opt/babylon/storage</li>
              <li><strong>Application Data:</strong> Stored in Docker volumes on your local system</li>
            </ul>
            <p className="text-text-primary mt-3">
              You maintain full control over your data. Uninstalling Babylon or deleting these
