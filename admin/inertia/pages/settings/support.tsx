...
export default function SupportPage() {
  return (
    <SettingsLayout>
      <Head title="Support the Project | Babylon" />
      <div className="xl:pl-72 w-full">
        <main className="px-12 py-6 max-w-4xl">
          <h1 className="text-4xl font-semibold mb-4">Support the Project</h1>
          <p className="text-text-muted mb-10 text-lg">
            Babylon is 100% free and open source — no subscriptions, no paywalls, no catch.
          ...
          <section className="mb-12">
            ...
            <p className="text-text-muted mb-4">
              Every contribution helps fund development, server costs, and new content packs for Babylon.
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-text-muted">
              <li>
                <a
                  href="https://github.com/elitk1919/babylon"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {' '}— it helps more people discover Babylon
              </li>
              <li>
                <a
                  href="https://github.com/elitk1919/babylon/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:underline"
                >
                ...
                {' '}— every report makes Babylon better
              </li>
              <li>Share Babylon with someone who'd use it — word of mouth is the best marketing</li>
              <li>
                <a
