...
This guide will help you get the most out of your Babylon server.

---

## Easy Setup Wizard

If this is your first time using Babylon, the Easy Setup wizard will help you get everything configured.
...
Babylon includes a built-in AI chat interface powered by Ollama. It runs entirely on your server — no internet needed, no data sent anywhere.
...
**GPU Acceleration:** If your server has an NVIDIA GPU with the [NVIDIA Container Toolkit](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/latest/install-guide.html) installed, Babylon will automatically use it for AI — dramatically faster responses (10-20x improvement). If you add a GPU later, go to [Apps](/settings/apps) and **Force Reinstall** the AI Assistant to enable it.
...
- Babylon documentation is automatically loaded when the AI Assistant is installed
...
Babylon includes a dedicated Wikipedia content management tool for browsing and downloading Wikipedia packages.
...
![System Benchmark with Babylon Score and Builder Tag](/docs/benchmark.webp)

Test your hardware performance and see how your Babylon build stacks up against the community.

**How to use it:**
1. Go to **[System Benchmark →](/settings/benchmark)**
2. Choose a benchmark type: Full, System Only, or AI Only
3. View your Babylon Score (a weighted composite of CPU, memory, disk, and AI performance)
4. Create a Builder Tag (your Babylon-themed identity, like "Tactical-Llama-1234")
...
You're ready to use Babylon Here are some things to try:
